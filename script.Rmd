...
O dataframe ainda possui um erro importante. Para os anos em que o FOCUS saiu muito próximo do dia 31/12, a função de conversão de semanas para dia/mês/ano está inserindo NA.
