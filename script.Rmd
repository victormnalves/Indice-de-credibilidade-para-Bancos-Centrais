...
chile_target <- tibble(year = c('2007', '2008', '2009', '2010', '2011', '2013', '2014', 
                                ...
                                '2022', '2023', '2024'), 
                           current = c(NA, NA, NA, NA, NA, 3, 3,
                                       3, 3, 3, 3, 3, 3, 3,
                                       3, 3, 3),
                           superior = c(NA, NA, NA, NA, NA, 4, 4,
                                       4, 4, 4, 4, 4, 4, 4,
                                       4, 4, 4),
                           inferior = c(NA, NA, NA, NA, NA, 2, 2,
                                       2, 2, 2, 2, 2, 2, 2,
                                       2, 2, 2))
```
...
```{r}
database <- rbind(data_brazil, data_canada, data_argentina, data_chile) %>% 
    mutate(
